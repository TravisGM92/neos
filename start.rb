...
# print ">>"
NearEarthObjects.new
date = gets.chomp
CreateTable.columns(NearEarthObjects.astroid_list(date))
CreateTable.results(date)
# astroid_details = NearEarthObjects.find_neos_by_date(date)
# astroid_list = NearEarthObjects.astroid_list(date)
# total_number_of_astroids = NearEarthObjects.total_number_of_astroids(date)
# largest_astroid = NearEarthObjects.largest_astroid(date)
...
# header = CreateTable.headers
# divider = CreateTable.dividers
...
# puts divider
# puts header
# CreateTable.create_rows(astroid_list, column_data)
# puts divider
